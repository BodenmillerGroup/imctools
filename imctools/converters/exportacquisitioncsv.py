...
def _read_and_concat(ome_folder: str, suffix: str, idname: str):
    ...
    dat = pd.concat([pd.read_csv(os.path.join(ome_folder, a, a + suffix)) for a in ac_names], keys=ac_names, names=[COL_AC_SESSION])
...
def export_acquisition_csv(ome_folder: str, output_folder: str, outname=AC_META):
...
if __name__ == "__main__":
    ...
    export_acquisition_csv(
        ...
        "/home/anton/Downloads/csv_folder"
    )
